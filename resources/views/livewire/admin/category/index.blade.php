        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 text-center" id="exampleModalLabel">Are You Sure?</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <form wire:submit.prevent="destroyCategory">
                    <div class="modal-body">
                        Are you sure to delete this category? You will lost it forever!
                    </div>
        ...
        <div class="col-md-12-grid-margin">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('category-create') }}" class="btn btn-primary text-white float-end">Add Category</a>
                </div>
